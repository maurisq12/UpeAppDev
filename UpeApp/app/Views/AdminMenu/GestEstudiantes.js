                        ...
                        loading ? (<Text> Cargando... </Text>) : (
                            data.map((post) => (
                                <View key={post.idEstudiante}>
                                    <Text style={{ fontSize: 20, fontWeight: 'bold' }}>ID estudiante:{post.idEstudiante}</Text>
                                    <Text style={{ fontSize: 20 }}>Nombre: {post.nombre+post.apellido1+post.apellido2}</Text>
                                    <Text style={{ fontSize: 20 }}>Carne: {post.carne}</Text>
